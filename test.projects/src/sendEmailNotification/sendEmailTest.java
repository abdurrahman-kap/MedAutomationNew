...
{	
	...
	public static void EmailNotification(String path)
	{
		try
		{
			...
			String [] allFileList = listFiles("C:\\Users\\AbRahman\\Desktop\\Step1HYTitleVerification.xlsx");
			EmailNotification emailTO = new EmailNotification( Arrays.asList("abdur.rahman@kaplan.com","abdur.rahman@kaplan.com"/*,"ANBARASAN_VENKATACHALAM@homedepot.com"*/), "no-reply@homedepot.com", 
					"Sanity Test Results - "+date,"Hi All" ,  BodyType.HTML );
