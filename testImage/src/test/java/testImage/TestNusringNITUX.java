...
public class TestNusringNITUX {
	...
	private WebDriver driver ;
		...
		*/
		...
		public void clickOnDeleteSession(String textSessionName){
			for (int i = 1; i < 1500; i++) {
				...
				if (testNameconf > 0) {
					...
					if(testSessionNameVal.equalsIgnoreCase(textSessionName)){
...
//******************************************************************************** 
		public void clickAddAllStudents(){
			WebElement clickAddAllStudents = driver.findElement(By.xpath(".//*[@id='addAllStudents']"));
			clickAddAllStudents.click();
			}
		/*public void studentNumber(){
			studentNumber = driver.findElement(By.xpath(".//*[@id='studentAddedToTestingSession']"));
			String studentNumber = studentNumber.getText();
		}*/
		public void clickReviewStudents(){
			WebElement clickReviewStudents = driver.findElement(By.xpath(".//*[@id='reviewDetails']"));
			clickReviewStudents.click();
		}
		public void setSessionName(String sName){
			WebElement sessionName = driver.findElement(By.xpath(".//*[@id='txtSessionName']"));
			sessionName.clear();
			sessionName.sendKeys(sName);
		}
		public void clickScheduleTest(){
			WebElement clickScheduleTest = driver.findElement(By.xpath(".//*[@id='btnScheduleTest']"));
			clickScheduleTest.click();
		}
		
		/*public void clickOnAssignFacultyMember(){
			waitFor(5);
			int subName1 = driver.findElements(By.xpath("/review-test/main/div[1]/div/form/div[3]/div/button")).size();
			//System.out.println("Checking Number : "+subName);
			if(subName1>0){
				WebElement clickOnSubName = driver.findElement(By.xpath("/review-test/main/div[1]/div/form/div[3]/div/button"));
				waitFor(2);
				String SubName1;
				SubName1 = clickOnSubName.getText();
				clickOnSubName.click();
			}
		}
			public void ChooseFacultyMember(String item){
				clickOnAssignFacultyMember();
				int subName1 = driver.findElements(By.xpath("//a/span[1][text()='" + item +"']")).size();
				System.out.println("Choose faculty member : "+subName1);	
				if(subName1>0){
					WebElement clickOnSubName = driver.findElement(By.xpath("//a/span[1][text()='" + item +"']"));
					waitFor(2);
					//subName = clickOnSubName.getText();
		...
		/*public void deleteSession(List<String> sessionName) {
			WebElement scheduleTestsTable = driver.findElement(By
					.xpath("//*[@id='tblScheduledTests']"));
			// To locate rows of table.
			List<WebElement> rows_table = tblScheduledTests.findElements(By
					.tagName("tr"));
					...
					for (int column = 0; column < columns_count; column++) {
						...
						System.out
								.println("Cell Value Of row number " + row
										...
										+ celtext);
						if (sName.equalsIgnoreCase(celtext)) {
							matchFound = true;
							continue;
						}
		...
		public String getSuccessMsg(){
			WebElement successMessage = driver.findElement(By.xpath("html/body/app/confirmation/main/div/div/h4"));
			//System.out.println("TestScheduling success Message is  : " + successMessage.getText());
			return successMessage.getText();
			
		}
		
		
		public void clickViewTestingSessionLink(){
			WebElement slinkName = driver.findElement(By.xpath("html/body/app/confirmation/main/div/div/div/a"));
			slinkName.click();
		}
		
		public void clickManageTestPageLink(){
			WebElement linkName = driver.findElement(By.xpath("html/body/app/view-test/main/div/div/div[1]/div[1]/a"));
			linkName.click();
		}
...
//********************************************************************************
		...
		public void test1()throws Exception {
			...
			clickOnMultiple();
			waitFor(3);
			//studentsInTestingSession();
			waitFor(2);
			clickReviewStudents();
			waitFor(2);
			setSessionName("test_test");
			waitFor(2);
			//TestSchedule.ChooseFacultyMember(facMember);
			clickScheduleTest();
			waitFor(2);
			clickViewTestingSessionLink();
			waitFor(2);
			clickManageTestPageLink();
			//ManageAccount.deleteSession(sessionNameList);
			waitFor(2);
			clickOnDeleteSession("test_test");
		}
