...
public class JasperLoginPageModel {
protected WebDriver driver = null;
	
	public JasperLoginPageModel(WebDriver driver){
		this.driver= driver;
	}
	
	public void setKecUserName(String uName){
		WebElement setName = driver.findElement(By.id("kecuserName"));
		setName.clear();
		setName.sendKeys(uName);
	}
	
	public void setKecPwd(String pwd){
		WebElement setName = driver.findElement(By.id("kecpassword"));
		setName.clear();
	...
	public void clickLogIn(){
		WebElement clickLogIn = driver.findElement(By.xpath("//tr[6]/td/input"));
		clickLogIn.click();
	}
