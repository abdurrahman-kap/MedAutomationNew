...
public class JasperQAPageModel {
protected WebDriver driver = null;
	
	public JasperQAPageModel(WebDriver driver){
		this.driver= driver;
	}
	
	public void setKECUserName(String uName){
		WebElement setName = driver.findElement(By.name("kecuserName"));
		setName.clear();
		setName.sendKeys(uName);
	}
	
	public void setKECPWD(String pwd){
		WebElement setName = driver.findElement(By.name("kecpassword"));
		setName.clear();
	...
	public void clickLogIn(){
		WebElement clickLogIn = driver.findElement(By.xpath("//tr[1]/td//tr[6]/td/input"));
		clickLogIn.click();
	}
